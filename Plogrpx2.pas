     ...
     begin
       ...
       Case GG of
            ...
            'M' : L6 := Cx +'Nome'+ConstStr(' ',39)+
                        ...
                        PushRight(6,EditReal(CMstMember.Moedas[09]))+' '+
                        PushRight(6,EditReal(CMstMember.Moedas[10]))+Cf;
            else L6 := 'Matr¡c.  Nome'+ConstStr(' ',38)+
                     ' Horas                 Valor';
       end;
       ParaContinua;
       Janela('F');
       ...
       Case GG of
            'L' : begin
                    ...
                    WriteLine('L',ConstStr(' ',59)+PushRight(20,EditReal(TProv)));
                  end;
            'M' : begin
                    WriteLine('L',Cx+ConstStr(' ',68)+
                                     ConstStr('-',6)+' '+
